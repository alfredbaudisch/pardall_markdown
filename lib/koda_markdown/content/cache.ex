defmodule KodaMarkdown.Content.Cache do
  require Logger
  alias KodaMarkdown.{Post, Link}
  import KodaMarkdown.Content.Filters
  import KodaMarkdown.Content.Utils

  @cache_name Application.compile_env!(:koda_markdown, [KodaMarkdown.Content, :cache_name])
  @index_cache_name Application.compile_env!(:koda_markdown, [
  ...
  defp do_build_content_tree(tree) do
    with_home =
      Application.get_env(:koda_markdown, KodaMarkdown.Content)[:content_tree_display_home]
