defmodule KodaMarkdown.Content.Utils do
  @taxonomy_index_file "_index.md"
  @root_path Application.compile_env!(:koda_markdown, [KodaMarkdown.Content, :root_path])
  @static_assets_folder_name Application.compile_env!(:koda_markdown, [
                               KodaMarkdown.Content,
  ...
  ## Examples
      ...
      iex> KodaMarkdown.Content.Utils.extract_categories_from_path("/blog/art/3d-models/post.md")
      [
      ...
      iex> KodaMarkdown.Content.Utils.extract_categories_from_path("/blog/post.md")
      [%{title: "Blog", slug: "/blog", level: 0, parents: ["/"]}]

      iex> KodaMarkdown.Content.Utils.extract_categories_from_path("/post.md")
  ...
  ## Examples
      ...
      iex> KodaMarkdown.Content.Utils.extract_slug_from_path("/blog/art/3d/post.md")
      "/blog/art/3d/post"

      iex> KodaMarkdown.Content.Utils.extract_slug_from_path("/blog/My new Project.md")
      "/blog/my-new-project"

      iex> KodaMarkdown.Content.Utils.extract_slug_from_path("/blog/_index.md")
      "/blog/-index"
  """
  ...
  ## Examples
      ...
      iex> KodaMarkdown.Content.Utils.extract_title_from_path("/blog/art/3d/post-about-art.md")
      "Post about art"

      iex> KodaMarkdown.Content.Utils.extract_title_from_path("/blog/My new Project.md")
      "My new Project"
  """
  ...
  ## Examples
      ...
      iex> KodaMarkdown.Content.Utils.capitalize_as_title("post-about-art")
      "Post about art"

      iex> KodaMarkdown.Content.Utils.capitalize_as_title("My new Project")
      "My new Project"

      iex> KodaMarkdown.Content.Utils.capitalize_as_title("2d 3D 4d-art: this is bugged, 3d should've been preserved as 3d not separate strings")
      "2d 3D 4d art: this is bugged, 3d should've been preserved as 3d not separate strings"

      iex> KodaMarkdown.Content.Utils.capitalize_as_title("Some Startup plans to expand quantum Platform of the Platforms with $500M investment")
  ...
  ## Examples
      ...
      iex> KodaMarkdown.Content.Utils.capitalize_as_taxonomy_name("post-about-art")
      "Post About Art"

      iex> KodaMarkdown.Content.Utils.capitalize_as_taxonomy_name("3d-models")
      "3D Models"

      iex> KodaMarkdown.Content.Utils.capitalize_as_taxonomy_name("Products: wood-chairs")
      "Products: Wood Chairs"

      iex> KodaMarkdown.Content.Utils.capitalize_as_taxonomy_name("products-above-$300mm")
