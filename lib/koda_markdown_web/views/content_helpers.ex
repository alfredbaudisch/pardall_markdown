defmodule KodaMarkdownWeb.ContentHelpers do
  ...
  ```elixir
  [
    %KodaMarkdown.Link{level: 0, name: "Home", parents: ["/"], slug: "/"},
    %KodaMarkdown.Link{level: 0, name: "Blog", parents: ["/"], slug: "/blog"},
    %KodaMarkdown.Link{level: 1, name: "Art", parents: ["/", "/blog"], slug: "/blog/art"},
    %KodaMarkdown.Link{level: 2, name: "3D", parents: ["/", "/blog", "/blog/art"], slug: "/blog/art/3d"}
  ]
  ```
